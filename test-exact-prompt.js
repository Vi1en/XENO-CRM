...
function generateSmartMockRules(prompt) {
  ...
  console.log('=== TESTING EXACT USER PROMPT ===');
...
// Test with the exact prompt from the user
const userPrompt = "customers who spend over 2500 and website visit is 5";
console.log('\n🧪 Testing with user prompt:', userPrompt);
const result = generateSmartMockRules(userPrompt);
