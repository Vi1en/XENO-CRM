...
export default function EditCustomer() {
  ...
  const loadCustomer = async () => {
    try {
      ...
      setFormData({
        ...
        totalSpend: customerData.totalSpend?.toString() || '',
        visits: customerData.visits?.toString() || '',
        tags: customerData.tags?.join(', ') || '',
        lastOrderAt: customerData.lastOrderAt ? new Date(customerData.lastOrderAt).toISOString().slice(0, 16) : ''
      })
    } catch (error) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need to be signed in to edit customers.</p>
        </div>
      </div>
    )
  }
  ...
  if (loading && !customer) {
    return <div className="min-h-screen flex items-center justify-center">Loading customer data...</div>
  }
          ...
          <div className="p-6">
            ...
            {success && (
              <div className="mb-6 bg-green-50 border-l-4 border-green-400 p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-green-700">Customer updated successfully! Redirecting to customers list...</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200">
                ...
                <p className="mt-1 text-sm text-gray-600">Update the customer details below</p>
              </div>
