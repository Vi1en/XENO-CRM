    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">You need to be signed in to create campaigns.</p>
          <button
            onClick={() => router.push('/')}
        ...
        <div className="pl-64">
          ...
          <div className="p-6">
            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900" style={{ fontSize: '1.875rem', margin: '0' }}>Create New Campaign</h1>
                <p className="mt-2 text-gray-600">Set up a new marketing campaign to reach your customers</p>
              </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Leave empty to save as draft. You can schedule it later.
                    </p>
                  </div>
                </div>
